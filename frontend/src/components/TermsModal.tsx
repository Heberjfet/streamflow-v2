      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden">
        ...
        >
          ...
          <section>
            ...
            <p>
              Bienvenido a <strong>StreamFlow</strong> (en adelante, la &quot;Plataforma&quot;), una plataforma de transmisión de contenido audiovisual en streaming operada por <strong>FLUX INDUSTRIES</strong> (en adelante, &quot;FLUX INDUSTRIES&quot;, &quot;la Empresa&quot;, &quot;nosotros&quot; o &quot;nuestro&quot;). Estos Términos y Condiciones de Uso (en adelante, los &quot;Términos&quot; o las &quot;Condiciones&quot;) constituyen un acuerdo legalmente vinculante entre usted (en adelante, el &quot;Usuario&quot;, &quot;usted&quot;, &quot;su&quot; o &quot;sus&quot;) y FLUX INDUSTRIES con respecto al acceso, uso y navegación por la Plataforma StreamFlow, incluyendo cualquier subdominio, aplicación móvil, servicio de API, y cualquier otra funcionalidad o servicio proporcionado por FLUX INDUSTRIES.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              El Usuario es el único y exclusivo responsable de: (a) mantener la confidencialidad de sus credenciales de acceso, incluyendo nombre de usuario, contraseña, códigos de verificación, tokens de sesión, y cualquier otra información de autenticación; (b) todas y cada una de las actividades que ocurran bajo su cuenta, independientemente de si fueron autorizadas o no; (c) notificar a FLUX INDUSTRIES de inmediato, a través de los canales de soporte designados, sobre cualquier uso no autorizado de su cuenta, cualquier violación o brecha de seguridad, o cualquier otra actividad sospechosa relacionada con su cuenta; y (d) mantener sus datos de perfil, información de contacto y demás datos actualizados y precisos en todo momento.
            </p>
            <p>
              FLUX INDUSTRIES no será, bajo ninguna circunstancia, responsable por cualquier pérdida, daño, perjuicio, costo o gasto, directo o indirecto, que resulte del uso no autorizado de la cuenta del Usuario, ya sea que dicho uso no autorizado sea resultado de negligencia, descuido, o cualquier otra causa imputable al Usuario. El Usuario acepta que FLUX INDUSTRIES podrá, a su sola discreción, verificar la información proporcionada durante el registro y adoptar las medidas que considere apropiadas en caso de detectarse información falsa, incompleta o engañosa.
            </p>
          </section>

          <section>
            <p className="font-bold">4. USO DE LA PLATAFORMA Y DISPONIBILIDAD DEL SERVICIO</p>
            <p>
              StreamFlow es una plataforma de código abierto (open source) y de uso completamente gratuito. Los usuarios pueden acceder a todas las funcionalidades de la plataforma sin costo alguno, incluyendo la subida, gestión y visualización de contenido de video.
            </p>
            <p>
              FLUX INDUSTRIES no almacena información de pago en sus servidores, ya que no se realizan transacciones financieras a través de la plataforma. El uso de la plataforma está sujeto únicamente a los términos y condiciones aquí establecidos.
            </p>
            <p>
              FLUX INDUSTRIES se reserva el derecho de modificar, suspender o discontinuar cualquier parte de los Servicios en cualquier momento, sin previo aviso y sin que ello genere derecho a compensación alguna a favor del Usuario.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Todo el contenido disponible en la Plataforma, incluyendo pero no limitándose a: textos, gráficos, logotipos, íconos, botones, imágenes, clips de audio y video, música, bandas sonoras, archivos de datos, bases de datos, catálogos, información de usuarios, interfaces de usuario, interfaces de programación, código fuente, código objeto, software, scripts, algoritmos, lógica de procesos, arquitectura de sistemas, documentación, manuales, guías de usuario, tutoriales, y cualquier otro material o contenido (en adelante, denominado conjuntamente como &quot;Contenido de FLUX INDUSTRIES&quot;), es propiedad exclusiva de FLUX INDUSTRIES, sus licenciantes, proveedores de contenido, socios comerciales, o cualquier otro titular de derechos, y está protegido por las leyes de propiedad intelectual aplicables, incluyendo pero no limitándose a las leyes de derecho de autor, marcas registradas, patentes, derechos de diseño, derechos de bases de datos, y tratados internacionales de propiedad intelectual.
            </p>
            <p>
              Salvo que se indique expresamente lo contrario en estos Términos, el Usuario no puede: (a) copiar, modificar, alterar, transformar, adaptar, traducir, crear obras derivadas de, o de cualquier otra forma explotar comercialmente o para fines de lucro cualquier Contenido de FLUX INDUSTRIES; (b) distribuir, vender, licenciar, sublicenciar, alquilar, arrendar, prestar, transmitir, exhibir públicamente, poner a disposición del público, o de cualquier otra forma transferir cualquier Contenido de FLUX INDUSTRIES a terceros; (c) eliminar, ocultar, o modificar cualquier aviso de derechos de autor, marca registrada, o cualquier otro aviso de propiedad intelectual contenido en el Contenido de FLUX INDUSTRIES; (d) realizar ingeniería inversa, descompilar, desensamblar, traducir, adaptar, o intentar descubrir el código fuente, algoritmos, o cualquier otra información técnica relacionada con la Plataforma; (e) utilizar robots, spiders, crawlers, scrapers, o cualquier otro medio automatizado para acceder, indexar, copiar, o extraer contenido de la Plataforma sin autorización previa por escrito de FLUX INDUSTRIES; o (f) eludir, ignorar, desactivar, o de cualquier otra forma interferir con las medidas de protección tecnológicas, sistemas de gestión de derechos digitales, o cualquier otra medida de seguridad implementada en la Plataforma.
            </p>
            <p>
              Los derechos no expresamente otorgados en estos Términos quedan reservados exclusivamente para FLUX INDUSTRIES y sus respectivos titulares de derechos. Cualquier uso no autorizado de cualquier Contenido de FLUX INDUSTRIES constituirá una violación de estos Términos y podrá constituir una infracción grave de la ley de propiedad intelectual aplicable, y expondrá al infractor a acciones civiles y/o penales. FLUX INDUSTRIES cooperará plenamente con las autoridades gubernamentales y/o judiciales en cualquier investigación relacionada con sospechas de infracción de propiedad intelectual.
            </p>
            <p>
              Todas las marcas registradas, nombres comerciales, logotipos, emblemas, lemas, diseños, y cualquier otro elemento de identidad corporativa utilizado en la Plataforma (en adelante, &quot;Marcas&quot;) son propiedad exclusiva de FLUX INDUSTRIES o de sus respectivos titulares. El Usuario no adquiere ningún derecho, título o interés en las Marcas por el uso de la Plataforma. Está estrictamente prohibido utilizar las Marcas de FLUX INDUSTRIES o de terceros sin la autorización previa por escrito del titular correspondiente.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Queda estrictamente prohibido, sin limitación: (a) utilizar la Plataforma para cualquier propósito ilegal o no autorizado, incluyendo la comisión de crímenes informáticos, fraude, robo de identidad, phishing, o cualquier otro delito informático; (b) cargar, publicar, transmitir, enviar por correo electrónico, o de cualquier otra forma distribuir contenido que sea difamatorio, abusivo, obsceno, pornográfico, sexual, amenazante, acosador, intimidatorio, humillante, racista, xenófobo, sexista, homofóbico, capaz de incitar al odio, violento, o de cualquier otra forma indeseable; (c) cargar, publicar, o transmitir contenido que infrinja derechos de autor, marcas registradas, patentes, secretos comerciales, o cualquier otro derecho de propiedad intelectual de terceros; (d) intentar acceder a las cuentas de otros Usuarios, a los sistemas de FLUX INDUSTRIES, a las redes de FLUX INDUSTRIES, o a cualquier cuenta, sistema o red que no le pertenezca; (e) realizar ingeniería inversa, descompilar, desensamblar, traducir, adaptar, o intentar descubrir el código fuente, algoritmos, protocolos, o cualquier otra información técnica de la Plataforma; (f) utilizar robots, spiders, crawlers, scrapers, o cualquier otro medio automatizado para acceder a la Plataforma sin autorización previa por escrito; (g) introducir, cargar, o transmitir virus, troyanos, gusanos, bombas lógicas, registradores de pulsaciones del teclado, rootkits, puertas traseras, o cualquier otro material malicioso o dañino; (h) intentar obtener acceso no autorizado a los sistemas, redes, servidores, o infraestructura de FLUX INDUSTRIES; (i) utilizar la Plataforma para acosar, amenazar, intimidar, humillar, o de cualquier otra forma causar daño a otros Usuarios o a terceros; (j) suplantar la identidad de cualquier persona o entidad, incluyendo empleados, agentes, o representantes de FLUX INDUSTRIES; (k) realizar inundación, spam, o cualquier otra actividad que pueda interferir con el funcionamiento normal de la Plataforma; (l) utilizar la Plataforma para enviar correos electrónicos no solicitados, mensajes no solicitados, o cualquier forma de comunicación no solicitada; (m) realizar cualquier actividad que pueda dañar, deshabilitar, sobrecargar, deteriorar, o negativamente afectar la Plataforma o los servidores, redes, o sistemas de FLUX INDUSTRIES; y (n) violar cualquier ley, regulación, o término de estos Términos.
            </p>
            <p>
              FLUX INDUSTRIES cooperará plenamente y sin reservas con las autoridades gubernamentales y/o judiciales en cualquier investigación relacionada con el uso ilegal de la Plataforma, incluyendo la revelación de la identidad, dirección IP, información de cuenta, historial de actividad, y cualquier otra información relevante del Usuario sospechoso de cometer crímenes o violaciones de la ley.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              La privacidad de los Usuarios es un valor fundamental para FLUX INDUSTRIES. FLUX INDUSTRIES se compromete a proteger la privacidad, los datos personales, y la información confidencial de los Usuarios de conformidad con las leyes de protección de datos aplicables, incluyendo cualquier regulación de protección de datos aplicable como el RGPD, la CCPA, la LGPD, o cualquier otra ley de privacidad que pueda ser relevante. La Política de Privacidad de FLUX INDUSTRIES está incorporada por referencia a estos Términos y constituye una parte integral de los mismos. Al utilizar la Plataforma, el Usuario consiente expresamente la recopilación, almacenamiento, procesamiento, uso, y transferencia de sus datos personales de conformidad con la Política de Privacidad.
            </p>
            <p>
              FLUX INDUSTRIES recopila diversos tipos de información personal del Usuario, incluyendo: (a) información proporcionada durante el registro, como nombre, correo electrónico, fecha de nacimiento, género, fotografía de perfil, y cualquier otra información proporcionada voluntariamente por el Usuario; (b) información de pago y facturación; (c) información sobre el uso de la Plataforma, incluyendo historial de visualización, búsquedas realizadas, contenido cargado, comentarios publicados, y preferencias del Usuario; (d) información técnica, como dirección IP, tipo de navegador, sistema operativo, identificadores de dispositivos, y cookies; y (e) cualquier otra información que el Usuario proporcione a FLUX INDUSTRIES a través de la Plataforma o de cualquier otro canal de comunicación.
            </p>
            <p>
              FLUX INDUSTRIES emplea medidas de seguridad técnicas, organizativas, y administrativas razonables y apropiadas para proteger los datos personales contra acceso no autorizado, pérdida, destrucción, alteración, divulgación, o uso indebido. Sin embargo, el Usuario reconoce y acepta que: (a) ningún sistema de seguridad es completamente impenetrable; (b) la transmisión de información a través de Internet no es 100% segura; (c) FLUX INDUSTRIES no puede garantizar la seguridad absoluta de los datos del Usuario; y (d) el Usuario utiliza la Plataforma bajo su propio riesgo en lo que respecta a la seguridad de sus datos personales.
            </p>
            <p>
              El Usuario tiene derechos sobre sus datos personales, incluyendo el derecho de acceso, rectificación, supresión, portabilidad, limitación del procesamiento, y objeción al procesamiento, de conformidad con la ley aplicable. Para ejercer cualquiera de estos derechos, el Usuario debe comunicarse con FLUX INDUSTRIES a través de los canales de soporte designados en la Plataforma. FLUX INDUSTRIES responderá a las solicitudes de ejercicio de derechos en los plazos establecidos por la ley aplicable.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Salvo que FLUX INDUSTRIES indique lo contrario, las modificaciones entrarán en vigor inmediatamente después de su publicación en la Plataforma, sin perjuicio de cualquier período de transición que FLUX INDUSTRIES pueda establecer. Es responsabilidad exclusiva del Usuario revisar estos Términos periódicamente, incluyendo cada vez que acceda a la Plataforma, para estar al tanto de cualquier cambio, modificación, o actualización. El uso continuado de la Plataforma por parte del Usuario después de la publicación de cualquier modificación constituirá la aceptación plena, expresa, e irrevocable de los Términos modificados.
            </p>
            <p>
            ...
            <p>
              FLUX INDUSTRIES podrá, a su sola discreción, proporcionar notificaciones sobre modificaciones a estos Términos a través de cualquier canal de comunicación que considere apropiado, incluyendo correo electrónico, notificaciones en la Plataforma, publicaciones en el blog de FLUX INDUSTRIES, redes sociales, o cualquier otro canal. Sin embargo, el Usuario reconoce y acepta que la falta de notificación individual no afectará la efectividad de las modificaciones publicadas.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>13.1 Cancelación por el Usuario.</strong> El Usuario puede cancelar su cuenta y suscripción en cualquier momento, sin necesidad de justificación, a través de la configuración de su cuenta en la Plataforma, siguiendo los procedimientos de cancelación establecidos por FLUX INDUSTRIES. La cancelación por parte del Usuario tomará efecto al final del período de facturación ya pagado. No habrá reembolsos por períodos parciales no utilizados, salvo que la ley aplicable exija lo contrario o que FLUX INDUSTRIES lo determine como un gesto comercial. La cancelación de la suscripción no implica la eliminación automática de la cuenta del Usuario; el Usuario puede mantener su cuenta gratuita incluso después de cancelar una suscripción de pago.
            </p>
            <p>
              <strong>13.2 Terminación por FLUX INDUSTRIES.</strong> FLUX INDUSTRIES puede, a su sola y exclusiva discreción, y sin previo aviso, suspender, restringir, limitar, o terminar de forma permanente o temporal: (a) el acceso del Usuario a la Plataforma o a cualquier parte de ella; (b) la cuenta del Usuario; (c) cualquier funcionalidad, servicio, o herramienta asociada con la cuenta del Usuario; y (d) la suscripción del Usuario. FLUX INDUSTRIES puede tomar estas acciones por cualquier motivo, incluyendo: (i) incumplos de estos Términos por parte del Usuario; (ii) incumplos de cualquier otra política, guía, o norma de FLUX INDUSTRIES; (iii) actividades ilegales, fraudulentas, o sospechosas; (iv) solicitudes de autoridades gubernamentales o judiciales; (v) problemas técnicos o de seguridad; (vi) falta de pago o problemas con el método de pago; (vii) inactividad prolongada de la cuenta; (viii) decisiones comerciales de FLUX INDUSTRIES; o (ix) cualquier otro motivo que FLUX INDUSTRIES considere suficiente.
            </p>
            <p>
              <strong>13.3 Efectos de la Terminación.</strong> Tras la terminación de la cuenta, ya sea por iniciativa del Usuario o de FLUX INDUSTRIES: (a) el derecho del Usuario a acceder y utilizar la Plataforma cesará inmediatamente; (b) todos los datos, contenido, y archivos asociados con la cuenta del Usuario podrán ser eliminados de forma permanente e irreversible, sin que FLUX INDUSTRIES esté obligado a mantener copias de seguridad o a proporcionar acceso a dichos datos; (c) todas las licencias y derechos otorgados al Usuario bajo estos Términos se suspenderán o terminarán inmediatamente; y (d) las disposiciones de estos Términos que, por su naturaleza, deban sobrevivir a la terminación, incluyendo las secciones relativas a propiedad intelectual, exención de garantías, limitación de responsabilidad, indemnización, confidencialidad, y disposiciones generales, permanecerán en pleno vigor y efecto.
            </p>
            <p>
              <strong>13.4 Reactivación.</strong> FLUX INDUSTRIES se reserva el derecho de evaluar las solicitudes de reactivación de cuentas previamente terminadas, a su sola discreción, y de establecer condiciones, requisitos, o términos adicionales para la reactivación.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Estos Términos se regirán, interpretarán, y ejecutarán de acuerdo con las leyes de la jurisdicción en la que FLUX INDUSTRIES tiene su sede principal o desde la cual opera, sin dar efecto a ningún principio de conflicto de leyes, independientemente del lugar donde se encuentre el Usuario o desde donde acceda a la Plataforma. Cualquier disputa, controversia, reclamo, o diferencia que surja de, se relacione con, o sea consecuencia de estos Términos, del uso de la Plataforma, de la relación entre el Usuario y FLUX INDUSTRIES, o de cualquier aspecto de los Servicios, será sometida exclusivamente a la jurisdicción de los tribunales competentes de la jurisdicción donde FLUX INDUSTRIES tiene su sede principal, y el Usuario acepta irrevocableablemente la jurisdicción exclusiva de dichos tribunales.
            </p>
            <p>
              El Usuario renuncia expresa e irrevocableablemente a cualquier objeción que pudiera tener respecto a la jurisdicción o el foro de cualquier acción, procedimiento, o proceso iniciado ante los tribunales de la jurisdicción de FLUX INDUSTRIES, y acepta no presentar defensas basadas en falta de jurisdicción, forum non conveniens, o cualquier otra defensa basada en la jurisdicción o el foro.
            </p>
            <p>
              <strong>ACUERDO DE ARBITRAJE OPCIONAL:</strong> Como alternativa a los tribunales, el Usuario y FLUX INDUSTRIES pueden acordar mutuamente que cualquier disputa sea sometida a arbitraje vinculante de conformidad con las reglas de arbitraje de la American Arbitration Association, las reglas de la International Chamber of Commerce, o cualquier otra organización de arbitraje que las partes acuerden por escrito. El arbitraje será conducido por un único árbitro mutuamente acordado por las partes, o en caso de desacuerdo, designado de conformidad con las reglas de arbitraje aplicables. El lugar del arbitraje será la ciudad donde FLUX INDUSTRIES tiene su sede principal. El idioma del arbitraje será el español, a menos que las partes acuerden lo contrario por escrito.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Estos Términos, junto con la Política de Privacidad, las Políticas de Uso Aceptable, las Condiciones de Suscripción, y cualquier otro documento, política, o acuerdo al que se haga referencia en este documento (conjuntivamente, el &quot;Acuerdo&quot;), constituyen el acuerdo completo, total, y exclusivo entre el Usuario y FLUX INDUSTRIES con respecto al uso de la Plataforma y reemplazan todos los acuerdos previos, representaciones, declaraciones, garantías, entendimientos, negociaciones, y comunicaciones, ya sean oralmente, por escrito, o de cualquier otra forma, entre el Usuario y FLUX INDUSTRIES con respecto al objeto de este Acuerdo.
            </p>
            <p>
            ...
            <p>
              El hecho de que FLUX INDUSTRIES no ejerza o no haga valer cualquier derecho, término, condición, disposición, obligación, o recurso establecido en estos Términos no constituirá una renuncia a dicho derecho, término, condición, disposición, obligación, o recurso, ni una renuncia o excusa continuado o futura del ejercicio de cualquier otro derecho, término, condición, disposición, obligación, o recurso. La renuncia de cualquier derecho o recurso por parte de FLUX INDUSTRIES deberá hacerse por escrito y firmada por un representante autorizado de FLUX INDUSTRIES para que sea efectiva.
            </p>
            <p>
              El Usuario no puede ceder, transferir, sublicenciar, delegar, o de cualquier otra forma enajenar o transmitir sus derechos u obligaciones bajo estos Términos sin el consentimiento previo y por escrito de FLUX INDUSTRIES. FLUX INDUSTRIES puede ceder, transferir, sublicenciar, delegar, o de cualquier otra forma enajenar o transmitir sus derechos u obligaciones bajo estos Términos sin restricción y sin necesidad de obtener el consentimiento del Usuario.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              El Usuario reconoce y acepta que: (a) tiene la capacidad legal para celebrar este Acuerdo y para utilizar la Plataforma; (b) toda la información proporcionada a FLUX INDUSTRIES durante el registro y el uso de la Plataforma es verdadera, precisa, completa, y actualizada; (c) cumplirá con todas las leyes, regulaciones, y normas aplicables al utilizar la Plataforma; (d) no utilizará la Plataforma para ningún propósito ilegal o no autorizado; (e) no interferirá con el funcionamiento normal de la Plataforma ni con el uso de la Plataforma por parte de otros Usuarios; y (f) acepta recibir comunicaciones electrónicas de FLUX INDUSTRIES, incluyendo correos electrónicos, notificaciones en la Plataforma, y mensajes SMS, relacionados con su cuenta, los Servicios, y cualquier aspecto de la relación entre el Usuario y FLUX INDUSTRIES.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Para cualquier pregunta, comentario, inquietud, queja, solicitud, o comentario relacionado con estos Términos, con la Plataforma, con los Servicios, con su cuenta, con el Contenido del Usuario, con la facturación, con la privacidad, o con cualquier otro aspecto de la relación entre el Usuario y FLUX INDUSTRIES, por favor comunícate con FLUX INDUSTRIES a través de los canales de soporte disponibles en la Plataforma, incluyendo el formulario de contacto, el chat de soporte, el correo electrónico de soporte, o cualquier otro canal que FLUX INDUSTRIES ponga a disposición del Usuario.
            </p>
            <p>
              Tu satisfacción como usuario de StreamFlow es nuestra prioridad número uno. Estamos aquí para ayudarte, para apoyarte, y para garantizar que tu experiencia en StreamFlow sea excepcional. No dudes en contactarnos.
            </p>
            <p>
